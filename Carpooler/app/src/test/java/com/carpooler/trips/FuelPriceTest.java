...
public class FuelPriceTest extends TestCase {
    ...
    private static final String URL = "http://devapi.mygasfeed.com/stations/radius/37.391025/-122.080143/1/reg/price/rfej9napna.json";
    ...
    public void testRequestFuelStations() {
        String response = fuelPrice.requestFuelStations(URL);

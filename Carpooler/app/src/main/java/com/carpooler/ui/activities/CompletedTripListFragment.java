...
/**
 * Created by jcsax on 6/29/15.
 */
public class CompletedTripListFragment extends TripListFragment implements DatabaseService.QueryCallback<TripData> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (args != null) {
            String status = args.getString(STATUS_ARG, TripStatus.COMPLETED.name());
